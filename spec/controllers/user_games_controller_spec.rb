...
describe UserGamesController do
  ...
  describe "GET index" do
    it "assigns all user_games as @user_games" do
      ...
      assigns(:user_games).should eq([user_game])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested user_game as @user_game" do
      ...
      assigns(:user_game).should eq(user_game)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new user_game as @user_game" do
      ...
      assigns(:user_game).should be_a_new(UserGame)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      it "creates a new UserGame" do
        expect {
          post :create, {:user_game => valid_attributes}, valid_session
        }.to change(UserGame, :count).by(1)
      end

      it "assigns a newly created user_game as @user_game" do
        post :create, {:user_game => valid_attributes}, valid_session
        assigns(:user_game).should be_a(UserGame)
        assigns(:user_game).should be_persisted
      end

      it "redirects to the created user_game" do
        post :create, {:user_game => valid_attributes}, valid_session
        response.should redirect_to(UserGame.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved user_game as @user_game" do
        ...
        post :create, {:user_game => { "user" => "invalid value" }}, valid_session
        assigns(:user_game).should be_a_new(UserGame)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "redirects to the user_game" do
        user_game = UserGame.create! valid_attributes
        put :update, {:id => user_game.to_param, :user_game => valid_attributes}, valid_session
        response.should redirect_to(user_game)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the user_game as @user_game" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        UserGame.any_instance.stub(:save).and_return(false)
        put :update, {:id => user_game.to_param, :user_game => { "user" => "invalid value" }}, valid_session
        assigns(:user_game).should eq(user_game)
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the user_games list" do
      user_game = UserGame.create! valid_attributes
      delete :destroy, {:id => user_game.to_param}, valid_session
      response.should redirect_to(user_games_url)
    end
  end
