...
class GameLevelsControllerTest < ActionController::TestCase
  ...
  test "should create game_level" do
    assert_difference('GameLevel.count') do
      post :create, game_level: { game_id: @game_level.game_id, level: @game_level.level, name: @game_level.name }
    end
  ...
  test "should show game_level" do
    get :show, id: @game_level
    assert_response :success
  end

  test "should get edit" do
    get :edit, id: @game_level
    assert_response :success
  end

  test "should update game_level" do
    patch :update, id: @game_level, game_level: { game_id: @game_level.game_id, level: @game_level.level, name: @game_level.name }
    assert_redirected_to game_level_path(assigns(:game_level))
  end
