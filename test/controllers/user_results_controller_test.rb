...
class UserResultsControllerTest < ActionController::TestCase
  ...
  test "should create user_result" do
    assert_difference('UserResult.count') do
      post :create, user_result: { game_level_id: @user_result.game_level_id, motivator_id: @user_result.motivator_id, user_game_id: @user_result.user_game_id, x: @user_result.x, y: @user_result.y }
    end
  ...
  test "should update user_result" do
    patch :update, id: @user_result, user_result: { game_level_id: @user_result.game_level_id, motivator_id: @user_result.motivator_id, user_game_id: @user_result.user_game_id, x: @user_result.x, y: @user_result.y }
    assert_redirected_to user_result_path(assigns(:user_result))
  end
